  ...
  async connectedCallback() {
    ...
    if (id) {
      try {
        ...
        this.querySelector("#prix-preinscription").innerHTML = this.evenement.journee == 'true' ? "$20" : "$40";
        this.querySelector("#prix-porte").innerHTML = this.evenement.journee == 'true' ? "30" : "$50";
